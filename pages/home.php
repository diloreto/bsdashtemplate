...
<div class="row">
    <div class="col-lg-3 col-md-6">
    	<a href="index.php?a=invoice" title="View Details">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <div class="panel-footer">
                        <span class="pull-left view-text">View Details</span>
...
<div class="row">
	<div class="col-lg-6 col-md-12">
        <h2>HamMar Projects Admin</h2>
        <p>Use the following links to do everything for your business</p>
    </div>
</div>
