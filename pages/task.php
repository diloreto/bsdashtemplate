...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            <i class="fa fa-tags" aria-hidden="true"></i> Tasks
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">
                <i class="fa fa-tags" aria-hidden="true"></i> <a href="index.php?a=task">Tasks</a>
            </li>
        </ol>
    </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="Job Title" name="Job Title" type="text" placeholder="123 Main St Basement" class="form-control input-md" required="">
  <span class="help-block">Enter Job Name</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="google_address" name="google_address" type="search" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="customeraddress1" name="customeraddress1" type="text" placeholder="123 Main St" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="address2" name="address2" type="text" placeholder="Apt 5" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="city" name="city" type="text" placeholder="Buffalo" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="zipcode" name="zipcode" type="text" placeholder="14224" class="form-control input-md" required="">
